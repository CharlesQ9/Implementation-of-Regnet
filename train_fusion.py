...
# Config
RUN_ID = 5
SAVE_PATH = str(Path('data_fusion')/'checkpoints_new' /
                'run_{:05d}'.format(RUN_ID))
LOG_PATH = str(Path('data_fusion')/'tensorboard_new' /
               'run_{:05d}'.format(RUN_ID))
...
# Load
LOAD_RUN_ID = 5
LOAD_MODEL_ID = 173600
LOAD_PATH = str(Path('data_fusion')/'checkpoints_new' /
