...
RUN_ID = 5
# modified to fit our model
SAVE_PATH = str(Path('data_v3_learn')/'checkpoints_new' /
                'run_{:05d}'.format(RUN_ID))
LOG_PATH = str(Path('data_v3_learn')/'tensorboard_new' /
               'run_{:05d}'.format(RUN_ID))
...
# Model
model = mod.RegNet_v3()  # modified to fit our model
...
# Load
LOAD_RUN_ID = 5
LOAD_MODEL_ID = 118400
LOAD_PATH = str(Path('data_v3_learn')/'checkpoints_new' /
