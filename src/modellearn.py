...
class RegNet_v3(nn.Module):
    def __init__(self):
        ...
        self.RGB_net2 = nn.Sequential(
            nn.Conv2d(96, 256, 5, 1, 2, bias=True),
            nn.ReLU(),
        ...
        self.RGB_net3 = nn.Sequential(
            nn.Conv2d(256, 384, 3, 1, 1, bias=True),
            nn.ReLU(),
            nn.Conv2d(384, 384, 1, 1, 0, bias=True),
            nn.ReLU(),
            nn.Conv2d(384, 384, 1, 1, 0, bias=True),
            nn.ReLU(),
            nn.MaxPool2d(3, stride=2, padding=1),
        ...
        self.fuse1 = nn.Sequential(nn.Conv2d(576, 512, 5, 1, 2, bias=True),
                                   nn.ReLU(),
    ...
    def forward(self, rgb_img, depth_img):
        ...
        matching_features = self.fuse1(concat_features)
